...
public class EatingDisorderServiceAdapter implements EatingDisorderService {

    protected String service;
    protected ObjectInputStream in;
    protected ObjectOutputStream out;

    public EatingDisorderServiceAdapter(String service, ObjectInputStream in, ObjectOutputStream out) {
    ...
    public JSONObject assignAllergy(Integer rightId, Integer leftId) throws Exception {
        ...
        submitRequest("assignallergy", data);

        return (JSONObject) in.readObject();
    }

    @Override
    public JSONObject assignIntolerance(Integer rightId, Integer leftId) throws Exception {
        JSONObject data = new JSONObject();
        data.put("rightId", rightId);
        data.put("leftId", leftId);

        submitRequest("assignintolerance", data);
